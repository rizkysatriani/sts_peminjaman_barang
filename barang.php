...
<a class="btn btn-primary" href="tambah2.php" role="button">Tambah Data</a>
<br>
<br>
...
<table class="table table-dark table-stripped">
  ...
  <th scope="row"><?php echo $no++; ?></th>
    ...
    <td>
	<a href="edit2.php?id=<?= $row['id']; ?>" class="btn btn-primary">Ubah</a> <a href="delete2.php?id=<?= $row['id']; ?>" class="btn btn-primary">Hapus</a>
    </td>
  </tr>
  <?php
      }
